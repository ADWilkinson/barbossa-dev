...
# Business hours check disabled - Barbossa can run at any time
# Previously restricted to outside 7:30am - 6:30pm UTC, Monday-Friday
# Uncomment the block below to re-enable business hours restriction
...
log_message "Proceeding with execution (business hours check disabled)"
